...
Revision ID: 26e6d0708891
Revises: 
Create Date: 2025-10-07 10:18:46.155526
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['related_to_CEO'], ['users.id'], name='users_related_to_CEO_fkey'),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['CEO_id'], ['users.id'], name=op.f('companies_CEO_id_fkey')),
