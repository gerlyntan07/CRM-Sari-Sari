  ...
  const fetchAllData = useCallback(async () => {
    ...
    try {
      ...
      const [
        ...
        api.get("/leads/sales/getLeads").catch((err) => {
          console.error("Error fetching leads:", err);
          return { data: [] };
        }),
        api.get("/deals/sales/fetch-all").catch((err) => {
          console.error("Error fetching deals:", err);
          return { data: [] };
        }),
        api.get("/accounts/sales/fetch-all").catch((err) => {
        ...
        api.get("/meetings/sales/fetch-all").catch((err) => {
          console.error("Error fetching meetings:", err);
          return { data: [] };
        }),
        api.get("/calls/sales/fetch-all").catch((err) => {
