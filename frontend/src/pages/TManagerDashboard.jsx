            ...
            <div key={index} className="relative flex-shrink-0 group">
              <button
                ...
                onClick={() => {
                  switch (item.label) {
                    case "Account":
                      navigate("/group-manager/accounts");
                      break;
                    case "Contact":
                      navigate("/group-manager/contacts");
                      break;
                    case "Leads":
                      navigate("/group-manager/leads");
                      break;
                    case "Deals":
                    ...
                    case "Quotes":
                      ...
                      break;
                    case "Target":
                      navigate("/group-manager/targets");
                      break;
                    case "Task":
  ...
  const handleSeeAll = () => {
    if (onSeeAll) {
      ...
      const routeMap = {
        ...
        "Upcoming Activities": "/group-manager/tasks",
      };
      if (routeMap[title]) {
...
const TManagerDashboard = () => {
  ...
  // Debug: Log render
  console.log(
    "TManagerDashboard rendering, loading:",
    loading,
    "error:",
    error
  );
