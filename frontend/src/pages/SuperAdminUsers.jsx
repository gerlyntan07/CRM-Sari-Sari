...
export default function SuperAdminUsers() {
  ...
  const detailView = selectedUser ? (
    ...
    >
      <div className="bg-white rounded-xl shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto hide-scrollbar animate-scale-in p-4 sm:p-6 md:p-8 font-inter relative">
