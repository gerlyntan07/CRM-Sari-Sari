...
Revision ID: 9243dbdc2161
Revises: c2da84b824ec
Create Date: 2025-10-15 10:40:04.475198
...
revision: str = '9243dbdc2161'
down_revision: Union[str, Sequence[str], None] = 'c2da84b824ec'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['CEO_id'], ['users.id'], name='companies_CEO_id_fkey', ondelete='CASCADE'),
