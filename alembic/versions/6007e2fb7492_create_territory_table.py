...
Revision ID: 6007e2fb7492
Revises: 
Create Date: 2025-10-17 11:37:58.018343
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['related_to_CEO'], ['users.id'], name=op.f('users_related_to_CEO_fkey'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['related_to_company'], ['companies.id'], name=op.f('users_related_to_company_fkey'), ondelete='CASCADE'),
