...
export default function AdminDealsQuickAction() {
  return (
    <div className="space-y-4 font-inter text-[13px] w-[85%] mx-auto">
      {/* Quick Actions */}
      <div className="bg-white border border-gray-100 rounded-lg p-4 shadow-sm">
        ...
        <div className="flex flex-col gap-1.5">
          {[
            ...
            <button
              key={text}
              className="flex items-center gap-2 border border-gray-100 rounded-md py-1.5 px-3 hover:bg-gray-50 transition"
            >
      ...
      <div className="bg-white border border-gray-100 rounded-lg p-4 shadow-sm">
        ...
        <select className="border border-gray-200 rounded-md px-3 py-1.5 w-full text-sm mb-2 focus:ring-2 focus:ring-gray-300">
