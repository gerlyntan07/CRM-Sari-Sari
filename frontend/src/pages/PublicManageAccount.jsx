...
export default function AdminManageAccount() {
  ...
  useEffect(() => {
    document.title = "Profile | Forekas";
  }, []);
  ...
  const handleApplyPromo = async () => {
    ...
    try {
      ...
      const message = error?.response?.data?.detail || "Failed to apply promo code. Please try again.";
      toast.error(message);
    } finally {
    ...
    <div className="p-2 lg:p-8 font-inter relative">
      ...
      <div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Redeem Promo / Coupon</h2>
          <p className="text-sm text-gray-600 mb-4">
            Apply available promo benefits directly from your account.
          </p>
              ...
              <div className="space-y-2">
                {availablePromos.slice(0, 8).map((promo) => (
                  <div key={promo.id} className="flex items-start justify-between gap-2 border border-gray-200 rounded-md p-3 bg-gray-50">
                    ...
                    <button
                      type="button"
                      onClick={() => setPromoCode((promo.manual_code || "").toUpperCase())}
